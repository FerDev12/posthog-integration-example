...
import { AlertOctagonIcon, FrownIcon } from "lucide-react";
...
export function LoginForm({
  ...
  function handleError(code: string) {
    setErrorMsg(
      authClient.$ERROR_CODES[code as keyof typeof authClient.$ERROR_CODES],
    );
  }

  async function handleLogin(
    data: z.infer<typeof signUpSchema> | z.infer<typeof signInSchema>,
  ) {
    setErrorMsg(null);
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="relative p-0 bg-card">
